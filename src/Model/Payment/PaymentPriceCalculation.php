 ...
 * @method \Shopsys\FrameworkBundle\Model\Pricing\Price calculateIndependentPrice(\App\Model\Payment\Payment $payment, \App\Model\Pricing\Currency\Currency $currency)
