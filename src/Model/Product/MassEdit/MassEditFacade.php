...
class MassEditFacade
{
    ...
    /**
     * @var \App\Model\Product\MassEdit\MassEditFormFactory
     */
    ...
    /**
     * @var \App\Model\Product\MassEdit\MassEditActionProvider
     */
    private $massEditActionProvider;

    /**
     * MassEditFacade constructor.
     * @param \App\Model\Product\MassEdit\MassEditFormFactory $massEditFormFactory
     * @param \App\Model\Product\ProductRepository $productRepository
     * @param \App\Model\Product\MassEdit\MassEditActionProvider $massEditActionProvider
     */
    ...
    private function getSelectedProductQueryBuilder(
        ...
        if ($selectType === self::SELECT_TYPE_CHECKED) {
            ...
            throw new \App\Model\Product\MassEdit\Exception\UnknownMassEditSelectionTypeException($selectType);
        }
