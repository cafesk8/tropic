...
class WorkdayService
{
    ...
    private const FIXED_HOLIDAYS_BY_LOCALE = [
        ...
        'en' => ['01.01.', '01.05.', '08.05.', '05.07.', '06.07.', '28.09.', '28.10.', '17.11.', '24.12.', '25.12.', '26.12.'],
    ];
    ...
    private function isFixedHoliday(DateTime $dateTime, string $locale): bool
    {
        if (!array_key_exists($locale, self::FIXED_HOLIDAYS_BY_LOCALE)) {
            throw new \App\Model\Transport\DeliveryDate\Exception\DeliveryDateLocaleNotSupportedException($locale);
        }
