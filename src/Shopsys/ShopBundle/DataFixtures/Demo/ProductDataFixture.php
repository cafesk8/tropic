...
class ProductDataFixture extends AbstractReferenceFixture implements DependentFixtureInterface
{
    ...
    protected function createVariants(): void
    {
        ...
        $parameter = $this->parameterFacade->findOrCreateParameterByNames(
            \Shopsys\ShopBundle\Model\Product\Parameter\ParameterFacade::PARAMETER_SIZE,
            \Shopsys\ShopBundle\Model\Product\Parameter\Parameter::TYPE_SIZE
        );
    ...
    protected function findParameterByNamesOrCreateNew(array $parameterNamesByLocale): Parameter
    {
        ...
        if ($parameter === null) {
            ...
            if ($parameterNamesByLocale === \Shopsys\ShopBundle\Model\Product\Parameter\ParameterFacade::PARAMETER_COLOR) {
                $parameterData->type = \Shopsys\ShopBundle\Model\Product\Parameter\Parameter::TYPE_COLOR;
            }
    ...
    protected function setBrand(ProductData $productData, ?string $brandReference): void
    {
        if ($brandReference !== null) {
            ...
            $brand = $this->persistentReferenceFacade->getReference($brandReference);
