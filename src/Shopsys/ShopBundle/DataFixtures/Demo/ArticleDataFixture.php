    ...
    protected function getDataForArticles(string $locale): array
    {
        return [
            [
                ...
                self::ATTRIBUTE_TEXT_KEY => t('Velkoobchodní prodej pro obchodníky provádíme již od roku 1992. Od roku 2013 umožňujeme obchodníkům s papírenským zbožím i pohodlný nákup přes tento internetový obchod. Každý zaregistrovaný zákazník vidí své aktuální ceny. O B2B mohou žádat pouze ochdodníci, kteří mají naše zboží určeno pro další prodej.', [], 'dataFixtures', $locale),
                self::ATTRIBUTE_PLACEMENT_KEY => Article::PLACEMENT_SERVICES,
            ], [
