...
use Shopsys\FrameworkBundle\Command\CreateDatabaseCommand as BaseCreateDatabaseCommand;
...
class CreateDatabaseCommand extends BaseCreateDatabaseCommand
{
    /**
     * @var string
     */
     ...
     */
    public function __construct(Localization $localization, System $system, PostgresqlLocaleMapper $postgresqlLocaleMapper, ManagerRegistry $managerRegistry)
    {
        parent::__construct($localization, $system, $postgresqlLocaleMapper, $managerRegistry);
