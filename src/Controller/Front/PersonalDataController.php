...
class PersonalDataController extends FrontBaseController
{
    ...
    public function indexAction(Request $request)
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $this->addSuccessFlash(t('E-mail with a link to the page with your personal data was sent to your e-mail address.'));
        }
    ...
    public function exportAction(Request $request)
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $this->personalDataAccessMailFacade->sendMail($personalData);
            $this->addSuccessFlash(t('E-mail with a link to the export of your personal data was sent to your e-mail address.'));
        }
