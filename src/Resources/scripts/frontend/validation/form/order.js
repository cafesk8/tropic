        ...
        $orderPersonalInfoForm.jsFormValidator({
            'groups': function () {
                ...
                if ($orderPersonalInfoForm.find('#order_personal_info_form_billingAddressFilled').is(':checked')) {
                    groups.push(Shopsys.constant('\\App\\Form\\Front\\Order\\PersonalInfoFormType::VALIDATION_GROUP_BILLING_ADDRESS_FILLED'));
                }
                ...
                if ($orderPersonalInfoForm.find('#order_personal_info_form_deliveryStreet') !== null) {
                    groups.push(Shopsys.constant('\\App\\Form\\Front\\Order\\PersonalInfoFormType::VALIDATION_GROUP_DELIVERY_ADDRESS_REQUIRED'));
                }
                if (isGermanDomain || isSlovakDomain) {
                    groups.push(Shopsys.constant('\\App\\Form\\Front\\Order\\PersonalInfoFormType::VALIDATION_GROUP_PHONE_PLUS_REQUIRED'));
                }
