...
interface ActorInterface
{
     ...
     */
    public function canSeeElement($selector, array $attributes = []);

    /**
     * @param array|string $selector
     * @param array $attributes
     */
    public function canSeeElementInDOM($selector, array $attributes = []);
     ...
     */
    public function canSeeInDatabase($table, array $criteria = []);

    /**
     * @param string $text
     * @param \Facebook\WebDriver\WebDriverElement $element
     */
    public function canSeeInElement($text, WebDriverElement $element);

    /**
     * @param string $value
     * @param \Facebook\WebDriver\WebDriverElement $element
     */
    public function canSeeInFieldByElement($value, WebDriverElement $element);
     ...
     * @param array $attributes
     */
    public function dontSeeElementInDOM($selector, array $attributes = []);
     ...
     */
    public function waitForElement(WebDriverElement $element, $timeout = null);
     ...
     * @param int $timeout seconds
     */
    public function waitForElementChange(WebDriverElement $element, Closure $callback, $timeout = null);

    /**
     * @param \Facebook\WebDriver\WebDriverElement $element
     * @param int $timeout seconds
     */
    public function waitForElementClickable(WebDriverElement $element, $timeout = null);

    /**
     * @param \Facebook\WebDriver\WebDriverElement $element
     * @param int $timeout seconds
     */
    public function waitForElementNotVisible(WebDriverElement $element, $timeout = null);

    /**
     * @param \Facebook\WebDriver\WebDriverElement $element
     * @param int $timeout seconds
     */
    public function waitForElementVisible(WebDriverElement $element, $timeout = null);
