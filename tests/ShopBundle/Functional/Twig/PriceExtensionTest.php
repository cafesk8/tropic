...
class PriceExtensionTest extends FunctionalTestCase
{
    ...
    {
        return [
            ['input' => Money::create(12), 'domainId' => 1, 'result' => '12,00' . self::NBSP . 'Kč'],
            ['input' => Money::create('12.00'), 'domainId' => 1, 'result' => '12,00' . self::NBSP . 'Kč'],
            ['input' => Money::create('12.600'), 'domainId' => 1, 'result' => '12,60' . self::NBSP . 'Kč'],
            ['input' => Money::create('12.630000'), 'domainId' => 1, 'result' => '12,63' . self::NBSP . 'Kč'],
            ['input' => Money::create('12.638000'), 'domainId' => 1, 'result' => '12,638' . self::NBSP . 'Kč'],
            ['input' => Money::create('12.630000'), 'domainId' => 1, 'result' => '12,63' . self::NBSP . 'Kč'],
            [
            ...
            [
                ...
                'domainId' => 1,
                'result' => '123' . self::NBSP . '456' . self::NBSP . '789,1234567891' . self::NBSP . 'Kč',
            ],
        ];
    }
